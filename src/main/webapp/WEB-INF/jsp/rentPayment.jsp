...
<!--   <style media="screen">
      ...
      <form:form action="saveelectricity" method="post">
         <nav class="navbar navbar-light bg-info">
            ...
            <div class="container-fluid" >
               ...
               <li class="nav-item">
                  <a class="nav-link active" href="/rentpayment"><b>Rent Payment</b></a>
               </li>
               <li class="nav-item">
 ...
 <tr>
   ...
   <td id="td1"></td>
    ...
    <td><input type="text" class="form-control" id="rent" placeholder=" Enter Rent *" value="" />
                        </td>
 </tr>
 <tr>
   <td   id="td1" class="text-danger"><b>Other Expenses</b></td>
   <td><input type="text" class="form-control" id="otherExpenses" placeholder=" Enter Other Expenses *" value="" />
   <td id="td1"></td>
   <td   id="td1" class="text-danger"><b>Payment Date</b></td>
   <td><input type="date" class="form-control" id="paymentDate" placeholder=" Enter Payment Date *" value="" />
                        </td>
 </tr>
 <tr>
   <td   id="td1" class="text-danger"><b>Payment Type</b></td>
   <td><input type="text" class="form-control" id="paymentType" placeholder=" Enter Payment Type *" value="" />
                        </td>
   <td id="td1"></td>
   <td   id="td1" class="text-danger"><b>Last Paid</b></td>
   <td><input type="text" class="form-control" id="lastPaid" placeholder=" Enter Last Paid *" value="" />
                   </td>
 </tr>
 <tr>
   <td   id="td1" class="text-danger"><b>Due Amount</b></td>
   <td><input type="text" class="form-control" id="dueAmount" placeholder=" Enter Due Amount *" value="" />
                   </td>
   <td id="td1"></td>
